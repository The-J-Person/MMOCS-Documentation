...
--
-- Table structure for table `healthpoints`
--

DROP TABLE IF EXISTS `healthpoints`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!50003 DROP PROCEDURE IF EXISTS `Add_Item_To_Inventory` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Add_Item_To_Inventory`(
		IN PlayerID INTEGER, IN ResourecID INTEGER, OUT Result INTEGER)
BEGIN
    ...
    ELSE
		SET Result = 1;
        IF( SELECT COUNT(*) FROM charinv WHERE UserID = PlayerID AND RID = ResourecID) = 0
        THEN
			INSERT INTO charinv ( UserID, RID, Amount ) VALUES(PlayerID ,ResourecID ,1);
		ELSE
			UPDATE charinv SET Amount = Amount + 1 WHERE UserID = PlayerID AND RID = ResourecID;      
		END IF;
	END IF;
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Get_HP_Of_Player` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Get_HP_Of_Player`(
...
BEGIN
	IF(SELECT COUNT(*) FROM user WHERE UserID = User) = 0
		THEN
			SET Result = -1;
		ELSE
			SET Result = (SELECT HP FROM healthpoints WHERE UserID = User) ;
		END IF;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Set_HP_Of_Player` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Set_HP_Of_Player`(
		IN User INTEGER, IN Health INTEGER, OUT Result INTEGER)
BEGIN
	IF(SELECT COUNT(*) FROM user WHERE UserID = User) = 0
		THEN
			SET Result = 0;
		ELSE
			SET Result = 1;
			UPDATE healthpoints SET HP = Health WHERE UserID = User;
		END IF;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
